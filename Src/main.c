  ...
  /* USER CODE BEGIN WHILE */
	while (1)
	{
		if(TimerFlag)
		{
			...
			if ((uBat < GLOBAL_settings_ptr->min_uBat) & (uPwr < GLOBAL_settings_ptr->min_uPwr))
			{
				SwAllLightOff();
				LEDOff();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, PERIP_PWR_Pin|BRIGHT_HIGH_Pin, GPIO_PIN_SET);
